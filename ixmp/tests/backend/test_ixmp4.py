...
class TestIxmp4Functions:
    ...
    def test__ni(self, ixmp4_backend: "IXMP4Backend") -> Any:
    ...
    def test_handle_config(self, ixmp4_backend: "IXMP4Backend") -> None:
    ...
    def test_set_node(
        self, ixmp4_backend: "IXMP4Backend", caplog: pytest.LogCaptureFixture
    ) -> None:
